...
void TargetAppearTime::DataConfig(const int& wCnt, const int& tCnt, const unique_input& input, std::vector<vec_target>& stageData)
{
...
void TargetAppearTime::Draw(const int& wCnt, const int& tCnt, const std::vector<vec_target> stageData)
{
	/// 設定中の状態描画
	SetFontSize(60);
